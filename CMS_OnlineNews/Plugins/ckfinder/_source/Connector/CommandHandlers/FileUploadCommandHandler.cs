            ...
            try
            {
                ...
                if (oFile != null)
                {
                    ...
                    if (Connector.CheckFileName(sFileName) && !Config.Current.CheckIsHiddenFile(sFileName))
                    {
                        ...
                        string sFileNameNoExt = CKFinder.Utils.SeoHelper.GetSeName(CKFinder.Connector.Util.GetFileNameWithoutExtension(sFileName));
                        string sFullExtension = CKFinder.Connector.Util.GetExtension(sFileName);
                        sFileName = sFileNameNoExt + sFullExtension;
                        int iCounter = 0;
                        ...
                        {
                            iCounter++;
                            sFileName = sFileNameNoExt + "_" + iCounter + sFullExtension;
