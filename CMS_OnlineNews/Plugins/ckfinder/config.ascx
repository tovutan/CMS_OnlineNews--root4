...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        return Session["IsLogin"] !=null && (bool)Session["IsLogin"];
    }
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "/Uploads/Images/tin-tuc/";
        ...
        Thumbnails.Url = BaseUrl + Session["CkFinder-Image-BaseUrl"] + "Thumbs" ?? "TinTuc/";
        if ( BaseDir != "" ) {
            Thumbnails.Dir = BaseDir + Session["CkFinder-Image-BaseUrl"] + "Thumbs" ?? "TinTuc/";
        }
        ...
        // "Url" is used to reach the thumbnails with the browser, while "Dir"
        // points to the physical location of the thumbnail files in the server.
        //Thumbnails2.Url = BaseUrl + "Mediums/" + Session["CkFinder-Image-BaseUrl"]??"post/";
        //if (BaseDir != "")
        //{
        //    Thumbnails2.Dir = BaseDir + "Mediums/" + Session["CkFinder-Image-BaseUrl"] ?? "post/";
        //}
        //Thumbnails2.Enabled = true;
        //Thumbnails2.DirectAccess = false;
        //Thumbnails2.MaxWidth = 640;
        //Thumbnails2.MaxHeight = 640;
        //Thumbnails2.Quality = 80;
        ...
        type.Url = BaseUrl + Session["CkFinder-Image-BaseUrl"] + "Originals" ?? "TinTuc/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "images/post/";
